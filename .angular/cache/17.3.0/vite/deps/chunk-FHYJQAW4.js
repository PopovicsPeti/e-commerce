...
import { CommonModule, DOCUMENT, NgTemplateOutlet } from "./chunk-HP6DT5TB.js";
import {
...
import { merge } from "./chunk-V2DXGMIT.js";
import {
  Observable,
  Subject,
  Subscription,
...
function MatFormField_ng_template_0_Conditional_0_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    ɵɵproperty("floating", ctx_r1._shouldLabelFloat())(
      "monitorResize",
      ctx_r1._hasOutline(),
    )("id", ctx_r1._labelId);
...
_MatFormFieldFloatingLabel.ɵfac = function MatFormFieldFloatingLabel_Factory(
  t,
) {
...
_MatFormFieldLineRipple.ɵfac = function MatFormFieldLineRipple_Factory(t) {
  return new (t || _MatFormFieldLineRipple)(
    ɵɵdirectiveInject(ElementRef),
...
_MatFormFieldNotchedOutline.ɵfac = function MatFormFieldNotchedOutline_Factory(
  t,
) {
  return new (t || _MatFormFieldNotchedOutline)(
    ɵɵdirectiveInject(ElementRef),
    ɵɵdirectiveInject(NgZone),
  );
};
...
var MAT_FORM_FIELD_DEFAULT_OPTIONS = new InjectionToken(
...
var _MatFormField = class _MatFormField {
  ...
  get floatLabel() {
    return (
      this._floatLabel || this._defaults?.floatLabel || DEFAULT_FLOAT_LABEL
    );
  }
  ...
  _updateOutlineLabelOffset() {
    ...
    const iconPrefixContainerWidth =
      iconPrefixContainer?.getBoundingClientRect().width ?? 0;
    const textPrefixContainerWidth =
...
_MatFormField.ɵcmp = ɵɵdefineComponent({
  ...
  hostBindings: function MatFormField_HostBindings(rf, ctx) {
    if (rf & 2) {
      ɵɵclassProp(
        ...
        ctx._animationMode === "NoopAnimations",
      )("mat-form-field-appearance-fill", ctx.appearance == "fill")(
        "mat-form-field-appearance-outline",
        ctx.appearance == "outline",
      )(
        "mat-form-field-hide-placeholder",
        ctx._hasFloatingLabel() && !ctx._shouldLabelFloat(),
      )("mat-focused", ctx._control.focused)(
        "mat-primary",
        ctx.color !== "accent" && ctx.color !== "warn",
      )("mat-accent", ctx.color === "accent")("mat-warn", ctx.color === "warn")(
        "ng-untouched",
        ctx._shouldForward("untouched"),
      )("ng-touched", ctx._shouldForward("touched"))(
        "ng-pristine",
        ctx._shouldForward("pristine"),
      )("ng-dirty", ctx._shouldForward("dirty"))(
        "ng-valid",
        ctx._shouldForward("valid"),
      )("ng-invalid", ctx._shouldForward("invalid"))(
        "ng-pending",
        ctx._shouldForward("pending"),
      );
    }
  },
  inputs: {
  ...
  template: function MatFormField_Template(rf, ctx) {
    if (rf & 1) {
      ...
      ɵɵtemplate(6, MatFormField_Conditional_6_Template, 2, 2, "div", 7)(
        7,
        MatFormField_Conditional_7_Template,
        3,
        0,
        "div",
        8,
      )(8, MatFormField_Conditional_8_Template, 3, 0, "div", 9);
      ɵɵelementStart(9, "div", 10);
      ɵɵtemplate(10, MatFormField_Conditional_10_Template, 1, 1);
      ɵɵprojection(11);
      ɵɵelementEnd();
      ɵɵtemplate(12, MatFormField_Conditional_12_Template, 2, 0, "div", 11)(
        13,
        MatFormField_Conditional_13_Template,
        2,
        0,
        "div",
        12,
      ...
      ɵɵtemplate(16, MatFormField_Case_16_Template, 2, 1)(
        17,
    ...
    if (rf & 2) {
      let tmp_16_0;
      ɵɵadvance(2);
      ɵɵclassProp("mdc-text-field--filled", !ctx._hasOutline())(
        "mdc-text-field--outlined",
        ctx._hasOutline(),
      )("mdc-text-field--no-label", !ctx._hasFloatingLabel())(
        "mdc-text-field--disabled",
        ctx._control.disabled,
      )("mdc-text-field--invalid", ctx._control.errorState);
      ɵɵadvance(2);
      ...
      ɵɵclassProp(
        ...
        ctx.subscriptSizing === "dynamic",
      );
      ɵɵadvance();
      ɵɵconditional(
        16,
        (tmp_16_0 = ctx._getDisplayedMessages()) === "error"
          ? 16
          : tmp_16_0 === "hint"
            ? 17
            : -1,
...
//# sourceMappingURL=chunk-FHYJQAW4.js.map
