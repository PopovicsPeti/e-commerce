...
function MatProgressSpinner_ng_template_0_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    ɵɵadvance();
    ɵɵstyleProp("stroke-dasharray", ctx_r0._strokeCircumference(), "px")(
      "stroke-dashoffset",
      ctx_r0._strokeCircumference() / 2,
      "px",
    )("stroke-width", ctx_r0._circleStrokeWidth(), "%");
    ɵɵattribute("r", ctx_r0._circleRadius());
  }
}
var MAT_PROGRESS_SPINNER_DEFAULT_OPTIONS = new InjectionToken(
...
var _MatProgressSpinner = class _MatProgressSpinner {
  ...
  constructor(_elementRef, animationMode, defaults) {
    ...
    this._noopAnimations =
      animationMode === "NoopAnimations" &&
      !!defaults &&
      !defaults._forceAnimations;
    this.mode =
...
_MatProgressSpinner.ɵfac = function MatProgressSpinner_Factory(t) {
  return new (t || _MatProgressSpinner)(
    ɵɵdirectiveInject(ElementRef),
    ɵɵdirectiveInject(ANIMATION_MODULE_TYPE, 8),
    ɵɵdirectiveInject(MAT_PROGRESS_SPINNER_DEFAULT_OPTIONS),
  );
};
_MatProgressSpinner.ɵcmp = ɵɵdefineComponent({
  ...
  viewQuery: function MatProgressSpinner_Query(rf, ctx) {
    ...
    if (rf & 2) {
      ...
      ɵɵqueryRefresh((_t = ɵɵloadQuery())) &&
        (ctx._determinateCircle = _t.first);
    }
  },
  hostAttrs: [
    "role",
  ...
  hostBindings: function MatProgressSpinner_HostBindings(rf, ctx) {
    if (rf & 2) {
      ɵɵattribute("aria-valuemin", 0)("aria-valuemax", 100)(
        "aria-valuenow",
        ctx.mode === "determinate" ? ctx.value : null,
      )("mode", ctx.mode);
      ɵɵclassMap("mat-" + ctx.color);
      ɵɵstyleProp("width", ctx.diameter, "px")("height", ctx.diameter, "px")(
        "--mdc-circular-progress-size",
        ctx.diameter + "px",
      )("--mdc-circular-progress-active-indicator-width", ctx.diameter + "px");
      ɵɵclassProp("_mat-animation-noopable", ctx._noopAnimations)(
        "mdc-circular-progress--indeterminate",
        ctx.mode === "indeterminate",
      );
    }
  },
  inputs: {
  ...
  template: function MatProgressSpinner_Template(rf, ctx) {
    ...
    if (rf & 2) {
      ...
      ɵɵadvance();
      ɵɵstyleProp("stroke-dasharray", ctx._strokeCircumference(), "px")(
        "stroke-dashoffset",
        ctx._strokeDashOffset(),
        "px",
      )("stroke-width", ctx._circleStrokeWidth(), "%");
          ...
          args: [
            {
              ...
              host: {
                ...
                "[class.mdc-circular-progress--indeterminate]":
                  'mode === "indeterminate"',
                "[style.width.px]": "diameter",
                "[style.height.px]": "diameter",
                "[style.--mdc-circular-progress-size]": 'diameter + "px"',
                "[style.--mdc-circular-progress-active-indicator-width]":
                  'diameter + "px"',
